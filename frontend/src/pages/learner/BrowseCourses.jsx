                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all duration-300 h-full flex flex-col">
                  <div className="relative h-48 overflow-hidden">
                    {course.thumbnail_url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary-500 via-secondary-500 to-primary-600">
                    ...
                    <div className="absolute top-3 left-3 flex flex-col gap-2">
                      ...
                      {course.is_enrolled && (
                        <span className="px-3 py-1 bg-success-500 text-white text-[10px] font-bold rounded-full flex items-center gap-1 shadow-lg shadow-success-500/20 w-fit">
